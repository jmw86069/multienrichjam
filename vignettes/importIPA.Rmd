...
output:
  rmarkdown::html_vignette:
    df_print: kable
vignette: >
  %\VignetteIndexEntry{Analysis of Ingenuity IPA enrichment data}
...
```{r, mem_canonical, fig.height=8, fig.width=7}
...
```{r, mem_folio, fig.height=7, fig.width=7}
...
```{r, enrich_hm, fig.height=8, fig.width=7}
...
```{r, enrich_hm_2, fig.height=8, fig.width=7}
...
```{r, mem_hm, fig.height=8, fig.width=7}
...
```{r, cnet_plot_1, fig.height=8, fig.width=7}
...
```{r, cnet_plot_2, fig.height=8, fig.width=7}
g2 <- cnet;
...
```{r, cnet_plot_1_custom, fig.height=8, fig.width=7}
